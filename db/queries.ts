...
import { userProgress,courses, units,challengeProgress,lessons, userSubscription } from "./schema";
...
export const getUserSubscription=cache(async()=>{
    ...
    const isActive=data.stripePriceId && data.stripeCurrentPeriodEnd && (data.stripeCurrentPeriodEnd.getTime() + DAY_IN_MS > Date.now());
